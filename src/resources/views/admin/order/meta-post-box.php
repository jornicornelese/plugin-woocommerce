...
<div class="biller-overview-box">
	...
	<div id="biller-payment-link-container"
		...
		<label class="biller-property-name" for="biller-payment-link-input">
			...
			<?php 
			echo wc_help_tip( __( 'The payment link will redirect the customer to Biller for payment.',
	...
	<div id="biller-payment-link-container"
		...
		<label class="biller-property-name">
			<?php echo esc_html__( 'Payment link', 'biller-business-invoice' ); ?>
			<?php 
			echo wp_kses( wc_help_tip( __( 'For Biller a company name is required for a valid payment link, please enter the custom field value of the order.',
